        ...
        do
            ...
            do
                ...
                python3 binns_DDP.py --data_seed 12345 --representative_sample --split grid2 --cross_val_idx $FOLD --n_folds 5 \
                    ...
                    --features ten --para_to_predict all --labels synthetic_function --label_noise_std 0 \
                    ...
                    --num_CPU 1 --use_ddp 1 --job_scheduler pbs --time_limit 11.5 --note "KAN_SYNTHETICFUNCTION_GRID30_ALL" $PLOT_STR
            done
        done
    done
done
