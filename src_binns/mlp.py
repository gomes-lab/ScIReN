...
class mlp_wrapper(nn.Module):
	def __init__(self, input_vars, var_idx_to_emb, vertical_mixing, vectorized='yes', pos_enc='early',
				 ...
				 kan_drop_rate=0.0, kan_drop_mode="postact", kan_drop_scale=True, kan_absolute_deviation=False):
		"""
		...
		if base_model == "lipmlp":
			...
			self.mlp = kan.KAN(width=layer_sizes, grid=kan_grid, k=3, seed=42, device=device, residual=residual,
							   ...
							   drop_scale=kan_drop_scale, absolute_deviation=kan_absolute_deviation)
