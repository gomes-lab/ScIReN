...
#SBATCH -J 5c_realfull_blackboxhybrid_hardsigmoid
# Request 4 GPUs 
# #SBATCH --gpus 4
        ...
        do
            ...
            do
                ...
                do
                    ...
                    python3 binns_DDP.py --data_seed 12345 --split grid2 --representative_sample --cross_val_idx $FOLD --n_folds 5 \
                        --optimizer AdamW --lr $LR --weight_decay $WD --batch_size 8 \
                        ...
                        --num_CPU 16 --use_ddp 1 --job_scheduler slurm --time_limit 71.5 --note "5C_SMALLBATCH" $PLOT_STR
                done
            done
        done
    done
