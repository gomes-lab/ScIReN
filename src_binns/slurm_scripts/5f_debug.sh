        ...
        do
            ...
            do
                ...
                python3 binns_DDP.py --data_seed 12345 --split grid2 --cross_val_idx $FOLD --n_folds 5 \
                    --optimizer AdamW --lr $LR --weight_decay 0 --n_epochs 2 \
                    --seed $SEED --init default --min_temp 1 --max_temp 1 \
                    --features ten --labels real \
                    --model kan --num_layers 1 --batch_size 5 \
                    ...
                    --num_CPU 32 --use_ddp 1 --job_scheduler slurm --time_limit 23.5 --note 5F_DEBUG $PLOT_STR
